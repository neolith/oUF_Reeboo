--[[------------------------------------
	...
	Based upon oUF_Lily & oUF_Mastiff
...
--[[     Files     ]]
local texture		= "Interface\\AddOns\\oUF_Reeboo\\textures\\statusbar"			-- bar texture
local border		= "Interface\\AddOns\\oUF_Reeboo\\textures\\border"				-- background border texture
local buffborder	= "Interface\\AddOns\\oUF_Reeboo\\textures\\buffborder"			-- buff border texture
local font			= "Interface\\AddOns\\oUF_Reeboo\\fonts\\ABF.ttf"				-- font
local overlay		= "Interface\\AddOns\\oUF_Reeboo\\textures\\overlay"			-- overlay texture for debuffs on player
local mohighlight	= "Interface\\AddOns\\oUF_Reeboo\\textures\\highlight"			-- mouseover highlight texture
...
--[[     Register Style     ]]
oUF:RegisterStyle("Reeboo", func)


--[[     Spawn Frames     ]]
oUF:SetActiveStyle"Reeboo"

local player = oUF:Spawn("player")
player:SetPoint("TOPLEFT", UIParent, 5, -40)
	...
	party:SetAttribute("template", "oUF_ReebooParty")
